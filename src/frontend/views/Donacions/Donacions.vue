<template>
    <div>
      <div class="infoContainer">
        <div class="pageTitle">NOM DE LA CAMPANYA</div>
      ...
      <div>
        <div class="objectsTitle">OBJECTES SORTEIG</div>
    ...
    this.donacions = [
      {
        img: "",
        title: "Casc MotoGP",
        colaborador: "@aleixespargaro",
      },
      {
        img: "",
        title: "Maillot equip Movistar",
        colaborador: "@enric_mas",
      }
    ]
  }

  showPaymentLayout () {
    return this.isPaymenyLayoutShown = !this.isPaymenyLayoutShown
  }
}
</script>
