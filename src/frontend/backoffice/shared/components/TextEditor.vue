  ...
  <div class="text-editor">
    <editor-menu-bar :editor="editor" v-slot="{ commands, isActive }">
      <div class="menubar row">
        <a class="menu-button" :class="{ 'is-active': isActive.bold() }" @click="commands.bold">
          <i class="material-icons">format_bold</i>
        </a>

        <a class="menu-button" :class="{ 'is-active': isActive.italic() }" @click="commands.italic">
          <i class="material-icons">format_italic</i>
        </a>

        <a class="menu-button" :class="{ 'is-active': isActive.strike() }" @click="commands.strike">
        ...
        <a class="menu-button" @click="commands.horizontal_rule">
          <i class="material-icons">remove</i>
        </a>

        <a class="menu-button" @click="commands.undo">
          <i class="material-icons">undo</i>
        </a>

        <a class="menu-button" @click="commands.redo">
